...
from .views_user_management import (
    UserListView, UserRoleEditView, UserRoleBulkAssignView, QuickRoleToggleView
)
...
#    path('import/critical-friends/', views.import_critical_friends_excel, name='import_critical_friends_excel'),
    ...
    path('reports/risk-dashboard/', views.risk_dashboard, name='risk_dashboard'),
 ...
 #   path('outputs/<int:pk>/approve/', views.output_approve, name='output_approve'),
    ...
    # NEW: DOI Metadata Fetch API (from evaluation)
    path('outputs/fetch-doi/', views.fetch_doi_metadata, name='fetch_doi_metadata'),
    path('outputs/bulk-import/', views.enhanced_bulk_import, name='enhanced_bulk_import'),
    path('outputs/csv-template/', views.download_csv_template, name='download_csv_template'),
...
path('outputs/import/', views.import_outputs, name='import_outputs'),
    ...
    path('manage/users/<int:user_id>/toggle/<str:role_code>/', QuickRoleToggleView.as_view(), name='user-role-toggle'),
