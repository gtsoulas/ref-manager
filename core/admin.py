...
class REFSubmissionAdmin(admin.ModelAdmin):
    ...
    fieldsets = (
        ...
        ('Status', {
            'fields': ('is_active', 'is_final', 'created_by')
        }),
